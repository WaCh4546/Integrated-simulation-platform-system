...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.last.setText(_translate("MainWindow", "上一张(A)"))
        self.last.setShortcut(_translate("MainWindow", "A"))
        self.next.setText(_translate("MainWindow", "下一张(D)"))
        self.next.setShortcut(_translate("MainWindow", "D"))
        self.save.setText(_translate("MainWindow", "保存并下一张(S)"))
        self.save.setShortcut(_translate("MainWindow", "S"))
        self.reset.setText(_translate("MainWindow", "重置当前所有操作(R)"))
